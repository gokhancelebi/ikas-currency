...
class RateServiceTest extends TestCase
{
    ...
    public function test_update_rates_via_http_writes_xml_files(): void
    {
        ...
        config([
            'shopify.rates.currency_xml' => $currencyPath,
            'shopify.rates.gold_xml' => $goldPath,
        ]);
    ...
    {
        config([
            'shopify.rates.currency_xml' => sys_get_temp_dir().'/missing-kurlar.xml',
            'shopify.rates.gold_xml' => sys_get_temp_dir().'/missing-altin.xml',
        ]);
    ...
    public function test_inspect_rates_for_ui_stale_rates(): void
    {
        ...
        config([
            'shopify.rates.currency_xml' => $currencyPath,
            'shopify.rates.gold_xml' => $goldPath,
            'shopify.rates.max_age_seconds' => 3600,
        ]);
